        ...
        <div>
            <section className="py-12 md:py-20 bg-slate-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-4">
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                ...
                                <h1 className='font-bold text-xl'>TARU PUBLICATIONS <span className='text-red-500'>*</span></h1>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                <Image src={'/partners/crcpress.jpg'} width={200} height={200} />
                                <h1 className='font-bold text-xl'>CRC PUBLICATIONS <span className='text-red-500'>*</span></h1>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                <Image src={'/partners/ijte.png'} width={200} height={200} />
                                <h1 className='font-bold text-xl'>IJTE-ISTE PUBLICATIONS <span className='text-red-500'>*</span></h1>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-4">
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                ...
                                <h1 className='font-bold text-xl'>Indian Society for Technical Education</h1>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                <Image src={'/partners/ieee.png'} width={200} height={200} />
                                <h1 className='font-bold text-xl'>Institute of Electrical and Electronics Engineers</h1>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardContent className="p-4 md:p-6 gap-4 flex flex-col justify-center items-center">
                                <Image src={'/partners/acm.png'} width={200} height={200} />
                                <h1 className='font-bold text-xl'>Association for Computing Machinery</h1>
                            </CardContent>
                        </Card>
